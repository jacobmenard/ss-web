...
<template>
  <div class="events-container">
    <div
      class="header-title d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center"
    >
      <span>Events</span>

      <b-button
        v-if="viewBy == 1"
        variant="ss-primary-button d-flex gap-10 align-items-center my-4"
        class="px-4"
        @click="viewDataBy(2)"
    ...
    <div v-if="!isLoadingEvents" class="event-wrapper d-flex gap-32 flex-wrap justify-content-center">
      <div
        ...
        :key="`event-${i}`"
        @click="goToEventAttendees(item.id)"
        class="event-card-container shadow-sm p-3 cursor-pointer border"
      >
        <div class="d-flex justify-content-between flex-column h-100">
          <div>
            ...
            <div
              ...
              style="width: 100%; height: 141.33px"
            >
